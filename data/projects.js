export const projects = [
  ...
  },
  {
    ...
    description:
      '"GameOn" est un projet de création de landing page à partir d\'un repo forké. Le travail a consisté de reprendre un code existant pour le rendre fonctionnel en fixant les issues préétablies par un autre développeur. Le developpement a été réalisé en HTML5, CSS3 et JavaScript. L\'entièreté du code est documenté et les maquettes du projet sont disponibles sur figma.',
  ...
  },
  {
    ...
    description:
      "Le projet \"Les petits plats\" est une page web qui se concentre sur le développement d'un moteur de recherche bien plus que sur le design de cette page. Cela explique l'absence de photographies de présentation des produits. L'algorithme qui a guidé le développement de la page vérifie la cohérence des scenarios proposés par les cas d'utilisations et s'est concentré sur la rapidité de ses calculs afin d'apporter un maximum de fluidité dans les recherches des utilisateurs.",
  ...
  },
  {
    ...
    abstract: "Page web d'un site e-commerce",
    description:
  ...
  },
  {
    ...
    description:
      "Le projet \"SportSee\" se concentre sur la réalisation de la page profil personnalisée d'un utilisateur d'une application web sportive. Le développement a été réalisé à l'aide de la technologie React en suivant une méthodologie de projet agile. Les user stories sont disponible dans un kanban publié sur notion et les maquettes sont sur figma. cette page profil inclus de nombreux éléments graphiques qui repose sur l'utisation de la bibliothèque Recharts. Une documentation technique est disponible dans la section wiki du repo sur GitHub",
